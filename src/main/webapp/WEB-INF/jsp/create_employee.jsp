...
<div class="container d-flex justify-content-center align-items-center" style="height:85vh;">
    ...
    <div class="col-md-6">
        <div class="main-card">
            ...
            <h2 class="title text-center">Create Employee</h2>
            <p class="subtitle text-center">Add new employee details to the system</p>
            ...
            <form action="${pageContext.request.contextPath}/employees" method="post">
                ...
                <button type="submit" class="btn btn-save w-100">Save Employee</button>
